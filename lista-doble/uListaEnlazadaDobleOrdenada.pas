unit uListaEnlazadaDobleOrdenada;
...
type
    ...
    { Ejercicio 13: Implementar un procedimiento que inserte un elemento en una lista doblemente enlazada ordenada. }
    ...
    { Para los tests, no se puede usar esta función}
